...
# test source modules
MODULES_TEST = test_scanner test_token test_object test_instruction test_utility test_expr test_parser

# modules from core that can be testsd
TESTABLE_MODULES = scanner token object instruction error utility expr astprinter parser
