...
syn keyword asmSettings		define enum org include db dw incbin fn for while if let bss dh dd
syn match asmSettings "^[.][a-z]*"

syn match decNumber	"\<\d\+\>"
syn match hexNumber	"0x\x\+\>" " 'bug', but adding \< doesn't behave!
